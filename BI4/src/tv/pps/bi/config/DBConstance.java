...
public class DBConstance {
	...
	public final static String TABLE_SEND_DATA = "send_data"; // 发送数据记录表
	public final static String TABLE_NET_INFO="netinfo";
	...
	// 创建发送数据记录表
	public final static String CREATE_TABLE_SEND = "create table if not exists "
			+ TABLE_SEND_DATA
			+ "(_id integer primary key autoincrement , send_time text)";

	public final static String CREATE_TABLE_NET="create table if not exists "
			+ TABLE_NET_INFO
			+ "(_id integer primary key autoincrement , net_time text , net_flag integer)";
